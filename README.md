...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v0.3.36-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v0.3.36-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-upgrade-7-2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-agoric-agoric-upgrade-7-2`|[Example](./agoric)|
|[akash](https://github.com/akash-network/node)|`v0.22.7`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-akash-v0.22.7`|[Example](./akash)|
|[assetmantle](https://github.com/AssetMantle/node)|`v0.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-assetmantle-v0.3.0`|[Example](./assetmantle)|
|[autonomy](https://github.com/AutonomyNetwork/autonomy-chain)|`v1.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-autonomy-v1.2.1`|[Example](./autonomy)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.5.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-bandchain-v2.5.1`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v1.7.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-bitcanna-v1.7.0`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.14.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-bitsong-v0.14.0`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.3.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-bostrom-v0.3.2`|[Example](./bostrom)|
|[canto](https://github.com/Canto-Network/Canto)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-canto-v5.0.0`|[Example](./canto)|
...
|[cosmoshub](https://github.com/cosmos/gaia)|`v9.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-cosmoshub-v9.1.1`|[Example](./cosmoshub)|
...
|[decentr](https://github.com/Decentr-net/decentr)|`v1.6.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-decentr-v1.6.2`|[Example](./decentr)|
|[defund](https://github.com/defund-labs/defund)|`v0.1.0-alpha`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-defund-v0.1.0-alpha`|[Example](./defund)|
...
|[evmos](https://github.com/evmos/evmos)|`v13.0.0-rc2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-evmos-v13.0.0-rc2`|[Example](./evmos)|
...
|[kava](https://github.com/Kava-Labs/kava)|`v0.23.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-kava-v0.23.1`|[Example](./kava)|
|[kichain](https://github.com/KiFoundation/ki-tools)|`5.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-kichain-5.0.1`|[Example](./kichain)|
|[konstellation](https://github.com/konstellation/konstellation)|`v0.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-konstellation-v0.5.0`|[Example](./konstellation)|
|[kujira](https://github.com/Team-Kujira/core)|`v0.8.7`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-kujira-v0.8.7`|[Example](./kujira)|
|[kyve](https://github.com/KYVENetwork/chain)|`v1.2.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-kyve-v1.2.2`|[Example](./kyve)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v4.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-likecoin-v4.0.1`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.4.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-lumnetwork-v1.4.2`|[Example](./lumnetwork)|
|[mars](https://github.com/mars-protocol/hub.git)|`v1.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-mars-v1.0.2`|[Example](./mars)|
|[migaloo](https://github.com/White-Whale-Defi-Platform/migaloo-chain)|`v2.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-migaloo-v2.0.2`|[Example](./migaloo)|
|[neutron](https://github.com/neutron-org/neutron)|`v1.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-neutron-v1.0.2`|[Example](./neutron)|
|[nois](https://github.com/noislabs/noisd)|`v1.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-nois-v1.0.2`|[Example](./nois)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v0.10.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-omniflixhub-v0.10.0`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v15.1.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-osmosis-v15.1.2`|[Example](./osmosis)|
...
|[sentinel](https://github.com/sentinel-official/hub)|`v0.9.3`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-sentinel-v0.9.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-shentu-v2.5.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.1.0-beta`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-sifchain-v1.1.0-beta`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-sommelier-v4.0.2`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v10.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-stargaze-v10.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v9.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-stride-v9.2.1`|[Example](./stride)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v1.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-teritori-v1.4.0`|[Example](./teritori)|
|[umee](https://github.com/umee-network/umee)|`v3.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-umee-v3.1.0`|[Example](./umee)|
|[vidulum](https://github.com/vidulum/mainnet)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v0.3.36-vidulum-v1.2.0`|[Example](./vidulum)|
