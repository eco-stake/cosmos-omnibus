...
Image URL: `ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-generic`

```yaml
services:
  node:
    image: ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-agoric-agoric-3.1`|[Example](./agoric)|
|[akash](https://github.com/ovrclk/akash)|`v0.16.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-akash-v0.16.3`|[Example](./akash)|
|[assetmantle](https://github.com/AssetMantle/node)|`v0.3.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-assetmantle-v0.3.0`|[Example](./assetmantle)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.3.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-bandchain-v2.3.3`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v.1.3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-bitcanna-v.1.3.1`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.10.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-bitsong-v0.10.0`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.2.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-bostrom-v0.2.0`|[Example](./bostrom)|
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-cerberus-v1.0.1`|[Example](./cerberus)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`v0.5.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-cheqd-v0.5.0`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v1.1.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-chihuahua-v1.1.1`|[Example](./chihuahua)|
|[comdex](https://github.com/comdex-official/comdex)|`v0.1.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-comdex-v0.1.1`|[Example](./comdex)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v7.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-cosmoshub-v7.0.1`|[Example](./cosmoshub)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v0.6.5`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-cronos-v0.6.5`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v3.3.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-cryptoorgchain-v3.3.3`|[Example](./cryptoorgchain)|
|[decentr](https://github.com/Decentr-net/decentr)|`v1.5.7`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-decentr-v1.5.7`|[Example](./decentr)|
|[defund](https://github.com/defund-labs/defund)|`v0.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-defund-v0.0.2`|[Example](./defund)|
|[desmos](https://github.com/desmos-labs/desmos)|`v2.3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-desmos-v2.3.1`|[Example](./desmos)|
|[dig](https://github.com/notional-labs/dig)|`v2.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-dig-v2.0.1`|[Example](./dig)|
|[emoney](https://github.com/e-money/em-ledger)|`v1.1.4`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-emoney-v1.1.4`|[Example](./emoney)|
|[fetchhub](https://github.com/fetchai/fetchd)|`v0.9.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-fetchhub-v0.9.1`|[Example](./fetchhub)|
...
|[likecoin](https://github.com/likecoin/likecoin-chain)|`fotan-1.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-likecoin-fotan-1.2`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.0.5`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-lumnetwork-v1.0.5`|[Example](./lumnetwork)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v7.2.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-osmosis-v7.2.1`|[Example](./osmosis)|
|[panacea](https://github.com/medibloc/panacea-core)|`v2.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-panacea-v2.0.2`|[Example](./panacea)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v0.1.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-persistence-v0.1.3`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v3.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-regen-v3.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.2.8`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-rizon-v0.2.8`|[Example](./rizon)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.8.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-sentinel-v0.8.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.2.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-shentu-v2.2.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v0.13.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-sifchain-v0.13.2`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v3.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-sommelier-v3.1.0`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v1.1.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-stargaze-v1.1.2`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.10.18`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-starname-v0.10.18`|[Example](./starname)|
|[terra](https://github.com/terra-money/core)|`v0.5.18`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-terra-v0.5.18`|[Example](./terra)|
|[thorchain](https://gitlab.com/thorchain/thornode)|`chaosnet-multichain`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-thorchain-chaosnet-multichain`|[Example](./thorchain)|
|[umee](https://github.com/umee-network/umee)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-umee-v1.0.1`|[Example](./umee)|
|[vidulum](https://github.com/vidulum/mainnet)|`v1.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.1.3-vidulum-v1.0.0`|[Example](./vidulum)|
