...
Image URL: `ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-generic`

```yaml
services:
  node:
    image: ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-generic
    env:
...
|---|---|---|---|
|[agoric](https://github.com/Agoric/ag0)|`agoric-3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-agoric-agoric-3.1`|[Example](./agoric)|
|[akash](https://github.com/ovrclk/akash)|`v0.16.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-akash-v0.16.3`|[Example](./akash)|
|[assetmantle](https://github.com/AssetMantle/node)|`v0.3.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-assetmantle-v0.3.0`|[Example](./assetmantle)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.3.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-bandchain-v2.3.3`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v.1.3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-bitcanna-v.1.3.1`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.11.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-bitsong-v0.11.0`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.2.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-bostrom-v0.2.0`|[Example](./bostrom)|
|[cerberus](https://github.com/cerberus-zone/cerberus)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-cerberus-v1.0.1`|[Example](./cerberus)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`v0.5.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-cheqd-v0.5.0`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v2.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-chihuahua-v2.0.1`|[Example](./chihuahua)|
|[chronicnetwork](https://github.com/ChronicNetwork/cht)|`v1.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-chronic-v1.1.0`|[Example](./chronic)|
|[comdex](https://github.com/comdex-official/comdex)|`v0.1.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-comdex-v0.1.1`|[Example](./comdex)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v7.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-cosmoshub-v7.0.2`|[Example](./cosmoshub)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v0.7.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-cronos-v0.7.0`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v3.3.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-cryptoorgchain-v3.3.3`|[Example](./cryptoorgchain)|
|[decentr](https://github.com/Decentr-net/decentr)|`v1.5.7`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-decentr-v1.5.7`|[Example](./decentr)|
|[defund](https://github.com/defund-labs/defund)|`v0.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-defund-v0.0.2`|[Example](./defund)|
|[desmos](https://github.com/desmos-labs/desmos)|`v2.3.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-desmos-v2.3.1`|[Example](./desmos)|
|[dig](https://github.com/notional-labs/dig)|`v2.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-dig-v2.0.1`|[Example](./dig)|
|[emoney](https://github.com/e-money/em-ledger)|`v1.1.4`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-emoney-v1.1.4`|[Example](./emoney)|
|[evmos](https://github.com/tharsis/evmos)|`v6.0.4`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-evmos-v6.0.4`|[Example](./evmos)|
|[fetchhub](https://github.com/fetchai/fetchd)|`v0.10.4`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-fetchhub-v0.10.4`|[Example](./fetchhub)|
|[gravitybridge](https://github.com/Gravity-Bridge/Gravity-Bridge)|`v1.4.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-gravitybridge-v1.4.1`|[Example](./gravitybridge)|
|[impacthub](https://github.com/ixofoundation/ixo-blockchain)|`v0.17.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-impacthub-v0.17.0`|[Example](./impacthub)|
|[irisnet](https://github.com/irisnet/irishub)|`v1.0.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-irisnet-v1.0.1`|[Example](./irisnet)|
|[juno](https://github.com/CosmosContracts/Juno)|`v9.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-juno-v9.0.0`|[Example](./juno)|
|[kava](https://github.com/Kava-Labs/kava)|`v0.16.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-kava-v0.16.1`|[Example](./kava)|
|[kixchain](https://github.com/KiFoundation/ki-tools)|`3.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-kichain-3.0.0`|[Example](./kichain)|
|[konstellation](https://github.com/konstellation/konstellation)|`0.5.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-konstellation-0.5.0`|[Example](./konstellation)|
|[kujira](https://github.com/Team-Kujira/core)|`v0.4.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-kujira-v0.4.0`|[Example](./kujira)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v3.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-likecoin-v3.0.0`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.0.5`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-lumnetwork-v1.0.5`|[Example](./lumnetwork)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v0.4.1`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-omniflixhub-v0.4.1`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v11.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-osmosis-v11.0.0`|[Example](./osmosis)|
|[panacea](https://github.com/medibloc/panacea-core)|`v2.0.2`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-panacea-v2.0.2`|[Example](./panacea)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v0.1.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-persistence-v0.1.3`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v3.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-regen-v3.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.2.8`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-rizon-v0.2.8`|[Example](./rizon)|
|[seinetwork](https://github.com/sei-protocol/sei-chain)|`1.1.0beta`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-seinetwork-1.1.0beta`|[Example](./seinetwork)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.8.3`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-sentinel-v0.8.3`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.2.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-shentu-v2.2.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v0.13.6`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-sifchain-v0.13.6`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v3.1.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-sommelier-v3.1.0`|[Example](./sommelier)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v5.0.0`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-stargaze-v5.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.10.18`|`ghcr.io/ovrclk/cosmos-omnibus:v0.2.8-starname-v0.10.18`|[Example](./starname)|
