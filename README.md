...
Image URL: `ghcr.io/akash-network/cosmos-omnibus:v1.2.32-generic`

```yaml
services:
  node:
    image: ghcr.io/akash-network/cosmos-omnibus:v1.2.32-generic
    env:
      ...
      # - PROJECT_DIR=.akash
      # - PROJECT_BIN=akash
      # - BINARY_URL=https://github.com/akash-network/node/releases/download/v1.0.0/akash_linux_amd64.zip
      # - BINARY_ZIP_PATH=build/akash-v1.0.0 # only required if expected binary file isn't in the ZIP root
```
...
|---|---|---|---|
|[akash](https://github.com/akash-network/node)|`v1.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-akash-v1.0.0`|[Example](./akash)|
|[archway](https://github.com/archway-network/archway)|`v9.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-archway-v9.0.0`|[Example](./archway)|
|[assetmantle](https://github.com/AssetMantle/node)|`v1.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-assetmantle-v1.0.0`|[Example](./assetmantle)|
|[atomone](https://github.com/atomone-hub/atomone)|`v2.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-atomone-v2.0.0`|[Example](./atomone)|
|[axelar](https://github.com/axelarnetwork/axelar-core)|`v1.2.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-axelar-v1.2.1`|[Example](./axelar)|
|[babylon](https://github.com/babylonlabs-io/babylon.git)|`v2.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-babylon-v2.1.0`|[Example](./babylon)|
|[bandchain](https://github.com/bandprotocol/chain)|`v2.5.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-bandchain-v2.5.3`|[Example](./bandchain)|
|[bitcanna](https://github.com/BitCannaGlobal/bcna)|`v4.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-bitcanna-v4.0.3`|[Example](./bitcanna)|
|[bitsong](https://github.com/bitsongofficial/go-bitsong)|`v0.21.6`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-bitsong-v0.21.6`|[Example](./bitsong)|
|[bostrom](https://github.com/cybercongress/go-cyber)|`v0.3.2`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-bostrom-v0.3.2`|[Example](./bostrom)|
|[canto](https://github.com/Canto-Network/Canto)|`v8.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-canto-v8.1.1`|[Example](./canto)|
|[cheqd](https://github.com/cheqd/cheqd-node)|`0.6.9`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-cheqd-0.6.9`|[Example](./cheqd)|
|[chihuahua](https://github.com/ChihuahuaChain/chihuahua)|`v9.0.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-chihuahua-v9.0.5`|[Example](./chihuahua)|
|[comdex](https://github.com/comdex-official/comdex)|`v15.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-comdex-v15.3.0`|[Example](./comdex)|
|[coreum](https://github.com/CoreumFoundation/coreum)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-coreum-v5.0.0`|[Example](./coreum)|
|[cosmoshub](https://github.com/cosmos/gaia)|`v25.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-cosmoshub-v25.1.1`|[Example](./cosmoshub)|
|[crescent](https://github.com/crescent-network/crescent)|`v4.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-crescent-v4.2.0`|[Example](./crescent)|
|[cronos](https://github.com/crypto-org-chain/cronos)|`v1.4.11`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-cronos-v1.4.11`|[Example](./cronos)|
|[cryptoorgchain](https://github.com/crypto-org-chain/chain-main)|`v6.0.3`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-cryptoorgchain-v6.0.3`|[Example](./cryptoorgchain)|
|[decentr](https://github.com/Decentr-net/decentr)|`v1.6.4`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-decentr-v1.6.4`|[Example](./decentr)|
|[desmos](https://github.com/desmos-labs/desmos)|`v6.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-desmos-v6.2.0`|[Example](./desmos)|
|[dydx](https://github.com/dydxprotocol/v4-chain)|`v9.4.0-rc0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-dydx-v9.4.0-rc0`|[Example](./dydx)|
|[dymension](https://github.com/dymensionxyz/dymension)|`v3.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-dymension-v3.1.0`|[Example](./dymension)|
|[emoney](https://github.com/e-money/em-ledger)|`v1.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-emoney-v1.2.0`|[Example](./emoney)|
|[evmos](https://github.com/evmos/evmos)|`v20.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-evmos-v20.0.0`|[Example](./evmos)|
|[fetchhub](https://github.com/fetchai/fetchd)|`v0.14.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-fetchhub-v0.14.1`|[Example](./fetchhub)|
|[gitopia](https://github.com/gitopia/gitopia)|`v5.1.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-gitopia-v5.1.0`|[Example](./gitopia)|
|[gravitybridge](https://github.com/Gravity-Bridge/Gravity-Bridge)|`v1.11.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-gravitybridge-v1.11.1`|[Example](./gravitybridge)|
|[impacthub](https://github.com/ixofoundation/ixo-blockchain)|`v0.18.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-impacthub-v0.18.1`|[Example](./impacthub)|
|[injective](https://github.com/InjectiveLabs/injective-chain-releases)|`v1.15.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-injective-v1.15.0`|[Example](./injective)|
|[intento](https://github.com/trstlabs/intento)|`v1.0.7`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-intento-v1.0.7`|[Example](./intento)|
|[irisnet](https://github.com/irisnet/irishub)|`v3.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-irisnet-v3.1.1`|[Example](./irisnet)|
|[jackal](https://github.com/JackalLabs/canine-chain)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-jackal-v5.0.0`|[Example](./jackal)|
|[juno](https://github.com/CosmosContracts/Juno)|`v29.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-juno-v29.0.0`|[Example](./juno)|
|[kava](https://github.com/Kava-Labs/kava)|`v0.25.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-kava-v0.25.0`|[Example](./kava)|
|[kichain](https://github.com/KiFoundation/ki-tools)|`5.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-kichain-5.0.1`|[Example](./kichain)|
|[konstellation](https://github.com/konstellation/konstellation)|`v0.5.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-konstellation-v0.5.0`|[Example](./konstellation)|
|[kujira](https://github.com/Team-Kujira/core)|`v2.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-kujira-v2.0.0`|[Example](./kujira)|
|[kyve](https://github.com/KYVENetwork/chain)|`v2.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-kyve-v2.2.0`|[Example](./kyve)|
|[likecoin](https://github.com/likecoin/likecoin-chain)|`v4.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-likecoin-v4.2.0`|[Example](./likecoin)|
|[lumnetwork](https://github.com/lum-network/chain)|`v1.6.7`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-lumnetwork-v1.6.7`|[Example](./lumnetwork)|
|[migaloo](https://github.com/White-Whale-Defi-Platform/migaloo-chain)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-migaloo-v5.0.0`|[Example](./migaloo)|
|[neutron](https://github.com/neutron-org/neutron)|`v6.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-neutron-v6.0.0`|[Example](./neutron)|
|[noble](https://github.com/noble-assets/noble)|`v5.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-noble-v5.0.0`|[Example](./noble)|
|[omniflixhub](https://github.com/OmniFlix/omniflixhub)|`v6.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-omniflixhub-v6.0.0`|[Example](./omniflixhub)|
|[osmosis](https://github.com/osmosis-labs/osmosis)|`v30.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-osmosis-v30.0.0`|[Example](./osmosis)|
|[panacea](https://github.com/medibloc/panacea-core)|`v2.2.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-panacea-v2.2.0`|[Example](./panacea)|
|[passage](https://github.com/envadiv/Passage3D)|`v2.6.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-passage-v2.6.0`|[Example](./passage)|
|[persistence](https://github.com/persistenceOne/persistenceCore)|`v10.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-persistence-v10.3.0`|[Example](./persistence)|
|[regen](https://github.com/regen-network/regen-ledger)|`v6.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-regen-v6.0.0`|[Example](./regen)|
|[rizon](https://github.com/rizon-world/rizon)|`v0.4.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-rizon-v0.4.1`|[Example](./rizon)|
|[sei](https://github.com/sei-protocol/sei-chain)|`v5.7.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-sei-v5.7.5`|[Example](./sei)|
|[sentinel](https://github.com/sentinel-official/hub)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-sentinel-v0.11.5`|[Example](./sentinel)|
|[shentu](https://github.com/certikfoundation/shentu)|`v2.11.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-shentu-v2.11.0`|[Example](./shentu)|
|[sifchain](https://github.com/Sifchain/sifnode)|`v1.4.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-sifchain-v1.4.0`|[Example](./sifchain)|
|[sommelier](https://github.com/PeggyJV/sommelier)|`v4.0.2`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-sommelier-v4.0.2`|[Example](./sommelier)|
|[source](https://github.com/Source-Protocol-Cosmos/source)|`v3.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-source-v3.0.1`|[Example](./source)|
|[stargaze](https://github.com/public-awesome/stargaze)|`v16.0.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-stargaze-v16.0.0`|[Example](./stargaze)|
|[starname](https://github.com/iov-one/starnamed)|`v0.11.5`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-starname-v0.11.5`|[Example](./starname)|
|[stride](https://github.com/Stride-Labs/stride)|`v29.1.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-stride-v29.1.1`|[Example](./stride)|
|[teritori](https://github.com/TERITORI/teritori-chain)|`v2.0.6`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-teritori-v2.0.6`|[Example](./teritori)|
|[terpnetwork](https://github.com/terpnetwork/terp-core)|`v5.0.1`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-terpnetwork-v5.0.1`|[Example](./terpnetwork)|
|[terra](https://github.com/terra-money/core)|`v2.11.8`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-terra-v2.11.8`|[Example](./terra)|
|[umee](https://github.com/umee-network/umee)|`v6.3.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-umee-v6.3.0`|[Example](./umee)|
|[xpla](https://github.com/xpladev/xpla)|`v1.7.0`|`ghcr.io/akash-network/cosmos-omnibus:v1.2.32-xpla-v1.7.0`|[Example](./xpla)|
